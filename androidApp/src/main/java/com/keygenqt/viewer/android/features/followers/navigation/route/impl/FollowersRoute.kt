 ...
 */
package com.keygenqt.viewer.android.features.followers.navigation.route.impl
...
/**
 * Routing for [FollowersScreen]
 */
object FollowersRoute {
    val default = object : NavScreen {
        override val route: String = "FollowersRouteDefault"
    }
}
