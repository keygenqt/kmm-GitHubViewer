...
/**
 * NavGraph for [FollowersScreen]
 */
@OptIn(ExperimentalAnimationApi::class)
fun NavGraphBuilder.followersGraph(
    appActions: AppActions,
) {
    composableAnimation(FollowersNavRoute.followers.default.route) {
        FollowersScreen(viewModel = hiltViewModel())
    }
}
